package com.cardlan.mall.common.utils;
...
//        System.out.println("---------------" + compareDate(getNowDate(), getDateTime("2020-08-02")));
//        System.out.println("---------------" + getDiffDays(getNowDate(), getDateTime("2020-06-08 11:32:25")));
//        System.out.println("---------------" + daysApart(getNowDate(), getDateTime("2020-06-09 11:32:25")));
//        System.out.println("---------------" + isSameDay(getNowDate(), getDateTime("2020-06-09 11:32:25")));
//        System.out.println("---------------" + isDateEqual(getNowDate(), getDateTime("2020-06-02 11:32:25")));
//        System.out.println("---------------" + getAfterDay(getNowDate()));
//        System.out.println("---------------" + getDateToStringYMDHMS(getNowDate()));
//        System.out.println("---------------" + getAnyTime(getNowDate(),10,10,61));
        System.out.println("------------" + beforeDay(getNowDate()));
    }
}